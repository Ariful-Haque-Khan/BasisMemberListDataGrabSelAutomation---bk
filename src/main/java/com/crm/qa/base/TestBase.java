	...
	public TestBase() {
		...
		try {
			...
			FileInputStream ip = new FileInputStream(
					"D:\\office\\BasisMemberListDataGrabSelAutomation\\src\\main\\java\\com\\crm\\qa\\config\\config.properties");
	...
	public static void initialization() {
		if (props.getProperty("browser").equals("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\jar_files\\chromedriver_win32\\94\\chromedriver.exe");
			driver = new ChromeDriver(); // launch chrome browser
		} else if (props.getProperty("browser").equals("edge")) {
			System.setProperty("webdriver.edge.driver",
					"D:\\office\\BasisMemberListDataGrabSelAutomation\\edgedriver_win64\\msedgedriver.exe");
